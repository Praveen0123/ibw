...
@Component({
  selector: 'app-sow-kanban-view',
  templateUrl: './sow-kanban-view.component.html',
  styleUrls: ['./sow-kanban-view.component.scss'],
  encapsulation: ViewEncapsulation.None,
    providers: [AlertService]
})
export class SowKanbanViewComponent implements OnInit {
  ...
  filterToggle: boolean = false;
    ...
    localData: any[] = [
        ...
        { id:"kanban_table_4", style:{'background-color':'rgb(204, 230, 253)'}, stage:'Drafting', header: 'Drafting (1)', data : [{ id: 'kanban_item_1164', name: 'Survey',  info: 'Updates: 2', colorCode: 'Green',percentage: '88%', campaign: 'Valleymede | Dave',projectcode:"7-12584 | 256 Street ", actions: 'Actions: 7/10',budget: 'Budget: $ 425/650',tasks:'Tasks: 85/100',duedate:'Due Date: 18-May-2019', hex: '#E0E0E0',}]},
