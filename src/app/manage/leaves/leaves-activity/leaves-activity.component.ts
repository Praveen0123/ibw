...
@Component({
  selector: 'app-leaves-activity',
  templateUrl: './leaves-activity.component.html',
  styleUrls: ['./leaves-activity.component.scss']
})
export class LeavesActivityComponent implements OnInit {
