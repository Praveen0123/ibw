...
import { week } from '../revenuebar';
import { Chart } from 'angular-highcharts';

@Component({
  selector: 'app-week-revenue',
  templateUrl: './week-revenue.component.html',
  styleUrls: ['./week-revenue.component.scss']
})
export class WeekRevenueComponent implements OnInit {
  // week: any[];
  // multi: any[];
