...
import { ExpensesStatusModalComponent } from './expenses-status-modal/expenses-status-modal.component';
...
export class ExpensesComponent implements OnInit {
  ...
  OpenExpenseStatusModal() {
    let dialogRef = this.dialog.open(ExpensesStatusModalComponent, {})
  }
